...
class Emailtemplate {
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																...
																You asked to reset your password.To do this please click the "Reset Password" button below (or '.base_url().'recover_pass) and enter this encryption key <span style="color:#EC8C0E">' . $encrypted_key . '</span> alongwith your registered email address.
															</multiline>
														</td>
													</tr>
																		...
																		<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																			<tr>
																				<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																					<multiline>
																						<a href="'.base_url().'recover_pass" style="text-decoration:none; color:#FFF;" data-color="link-white">Reset Password</a>
																					</multiline>
																				</td>
																			</tr>
																			<tr>
															...
															<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																	...
																	<tr>
																		<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																			<multiline>
																				Please click the "Activate Account" button below (or <a href="'.base_url().'login?email_segment=activate" target="_blank">'.base_url().'login?email_segment=activate</a>) & enter your email address & password to access your account. We look forward to helping you find and buy all of your cybersecurity in one place, in an hour for free!
																			</multiline>
																		</td>
																	</tr>
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																...
																To change your password, please click the below green "Reset Password" button (or <a href="'.base_url().'recover_pass" target="_blank">'.base_url().'recover_pass</a>) and enter this encryption key <span style="color:#EC8C0E">' . $encrypted_key . '</span> along with your registered email address.
															</multiline>
														</td>
													</tr>
																	...
																	<td valign="top" align="left">
																		<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																			<tr>
																				<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																					<multiline>
																						<a href="'.base_url().'recover_pass" style="text-decoration:none; color:#FFF;" data-color="link-white">Password Reset</a>
																					</multiline>
																				</td>
																			</tr>
																			<tr>
	...
	public function deligate_assign_question($email,$del_name,$username,$company){
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																'.ucwords($username).', '.$company.', would like your help with completing our questionnaire to help them find and buy all of their cybersecurity. Please click the "Be A Delegate" button or <a href="'.base_url().'be_delegate" target="_blank">'.base_url().'be_delegate</a> and complete your delegated questions.
															</multiline>
														</td>
													</tr>
																	...
																	<td valign="top" align="left">
																		<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																			<tr>
																				<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																					<multiline>
																						<a href="'.base_url().'be_delegate" style="text-decoration:none; color:#FFF;" data-color="link-white">Be a delegate</a>
																					</multiline>
																				</td>
																			</tr>
												...
												<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
													<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
														...
														<tr>
															<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																<multiline>
																	<span style="color:#6CA71B;">'. $fullname . ' ,'.$company.'</span> would like your help with completing our questionnaire to help them find and buy all of their cybersecurity in one place, in an hour for free. Please click the "Login Here" button or <a href="'.base_url().'delegate_login" style="text-decoration:none;" data-color="link-white">'.base_url().'delegate_login</a> using your email address and password to login. 
																</multiline>
															</td>
														</tr>
																		...
																		<td valign="top" align="left">
																			<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																				<tr>
																					<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																						<multiline>
																							<a href="'.base_url().'delegate_login" style="text-decoration:none; color:#FFF;" data-color="link-white">Login Here</a>
																						</multiline>
																					</td>
																				</tr>
																				<tr>
																	...
																	<td valign="top" align="left">
																		<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																			<tr>
																				<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																					<multiline>
																						<a href="'.base_url().'delegate_register" style="text-decoration:none; color:#FFF;" data-color="link-white">Sign up Here</a>
																					</multiline>
																				</td>
																			</tr>
																			<tr>
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																We have recieved your first month&#697;s payment of '.$currency.'&nbsp;'.number_format($amount,2).' & will take each future payment for the same amount on this date each month.
															</multiline>
														</td>
													</tr>
													<tr>
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																Please login by clicking the button below (or <a href="'.base_url().'login" target="_blank">'.base_url().'login</a>) to enjoy your service.
															</multiline>
														</td>
													</tr>
													<tr>
																	...
																	<td valign="top" align="left">
																		<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																			<tr>
																				<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																					<multiline>
																						<a href="'.base_url().'login" style="text-decoration:none; color:#FFF;" data-color="link-white">Login Here</a>
																					</multiline>
																				</td>
																			</tr>
																			<tr>
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																Thank you for your request. You have successfully signed up to our Subscription service. We have received your first month&#697;s payment of '.$currency.'&nbsp;'.number_format($subscription_price,2).' & will take each future payment on this date each month. Please login below to enjoy your service.
															</multiline>
														</td>
													</tr>
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																Below new SMB subscription (&b first month&#697;s '.$currency.'&nbsp;'.number_format($amount,2).' payment) received :
																<li>SMB ID: '.$sme_id.'</li>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please visit your orders page in your account  by clicking the button below (or <a href="'.base_url().'my_order" target="_blank">'.base_url().'my_order</a>) to check the status of yur refund.
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'my_order" style="text-decoration:none; color:#FFF;" data-color="link-white">Order Status</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please visit your "Orders" page in your account by clicking the button below (or <a href="'.base_url().'my_order" target="_blank">'.base_url().'my_order</a>) to see all of your orders.
																				</multiline>
																			</td>
																		</tr>
																		<tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'my_order" style="text-decoration:none; color:#FFF;" data-color="link-white">My Order</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please process this refund by clciking the below button (or <a href="'.base_url().'pending_refund_supplier" target="_blank">'.base_url().'pending_refund_supplier</a>), making sure to add proof of refund payment.
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'pending_refund_supplier" style="text-decoration:none; color:#FFF;" data-color="link-white">Refund Process</a>
																										</multiline>
																									</td>
																								</tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please check the status of your refund by visiting "Refunds" page by clicking below button (or <a href="'.base_url().'inprogress_refund_supplier" target="_blank">'.base_url().'inprogress_refund_supplier</a>). We will keep this updated as the refund is completed.
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'inprogress_refund_supplier" style="text-decoration:none; color:#FFF;" data-color="link-white">My Refund Status</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please visit the "processing refund request" page to complete this refund by clicking below button (or <a href="'.base_url().'processing_refund_request" target="_blank">'.base_url().'processing_refund_request</a>).
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'processing_refund_request" style="text-decoration:none; color:#FFF;" data-color="link-white">Refund Complete</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please visit the "processing refund request" page to see this refund by clicking below button (or <a href="'.base_url().'processing_refund_request" target="_blank">'.base_url().'processing_refund_request</a>).
																				</multiline>
																			</td>
																		</tr>
...
<a href="https://www.facebook.com/protectbox/" ><img src="'.base_url().'images/fb-1.png" width="30px"> </a>
	...
	public function smb_order_bundle($smb_email,$smb_name,$insert_order,$currency,$bundle_price,$company_name)
	{
		$message = '<!doctype html>
							<html lang="en">
							 <head>
															...
															<tr>
																...
																<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Please visit your Orders page for updates or to download your order now by clicking the "Order Status" button below (or <a href="'.base_url().'my_order" target="_blank">'.base_url().'my_order</a>).
																				</multiline>
																			</td>
																		</tr>
																					...
																					<tr>
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																								...
																								<tr>
																									<td style="line-height:20px; border-bottom: 1px solid #000; font-size:20px;" valign="middle" align="center" height="20"></td>
																								</tr>
																								<tr>
																									<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="middle" align="left">
																										As a thank you, we would like to offer you 1 month free to our subscription service (your auto-CISO/tiny admin fee to save your answers/Comparisons, market news, best buys & more, otherwise you’ll have to add your answers again each time), click here to apply this to your account. Or £20 cashback if you refer a friend.
																									</td>
																								</tr>		
																								<tr>
																									<td style="line-height:20px; border-bottom: 1px solid #000; font-size:20px;" valign="middle" align="center" height="20"></td>
	...
	public function supplier_order_bundle($smb_email,$smb_name,$insert_order,$currency,$bundle_price,$sme_id,$supplier_name,$smbfull_name,$smb_company)
	{
		$message = '<!doctype html>
							<html lang="en">
							 <head>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					We have received a payment of '.$currency.' '.number_format($bundle_price,2).' for the below Sale, invoice attached:  
																					<ul>
																						<li>Order number : '.$insert_order.'</li>
																						<li>Small & Medium Business (SMB) Customer Name : '.$smbfull_name.'</li>
																						<li>Small & Medium Business (SMB) Company Name: : '.$smb_company.'</li>
																						<li>SMB Email  : '.$smb_email.'</li>
																					</ul>
																				</multiline>
																			</td>
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					This payment has been processed to your account. Please allow a few working days for the transfer to complete.
																				</multiline>
																			</td>
																		</tr>
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To check the sale status, please click the “Sales Status” button below (or <a href="'.base_url().'my_order" target="_blank">'.base_url().'my_order</a>). Still need help? Email supplier@protectbox.com or call +44 (0)207 993 3037) or use chat on our website.
																				</multiline>
																			</td>
																		</tr>
																		<tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'my_order" style="text-decoration:none; color:#FFF;" data-color="link-white">Sale Status</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
...
<a href="https://www.facebook.com/protectbox/" ><img src="'.base_url().'images/fb-1.png" width="30px"> </a>
	...
	public function smb_order_bundle_admin($admin_fullname,$smb_email,$smb_name,$insert_order,$currency,$bundle_price,$sme_id,$smb_company)
	{
		$message = '<!doctype html>
							<html lang="en">
							 <head>
							  ...
							  <meta name="Keywords" content="">
							  <meta name="Description" content="">
							  <title>SMB Payment Update</title>
							 </head>
							 <body>
									<table data-bgcolor="BodyBg" data-module="notemail-2" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#f0f0f0" class="currentTable">
									<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																				We have received SMB payment of '.$currency.' '.number_format($bundle_price,2).' for the below Order, invoice(s) attached :
																					<ul>
																						<li>SME order number : '.$insert_order.'</li>
																						<li>SME order email : '.$smb_email.'</li>
																						<li>SME order company : '.$smb_company.'</li>
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the pending orders please click the “Pending Orders” button below (or <a href="'.base_url().'view_pending_orders" target="_blank">'.base_url().'view_pending_orders</a>).
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'view_pending_orders" style="text-decoration:none; color:#FFF;" data-color="link-white">Pending Orders</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
...
<a href="https://www.facebook.com/protectbox/" ><img src="'.base_url().'images/fb-1.png" width="30px"> </a>
	...
	public function delegate_reg_admin($admin_fullname,$fullname,$delegate_email,$del_name,$user_type,$company){
											...
											<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
												<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
															<multiline>
																A new delegate user has been assigned for '.$company.'.<br>
																Please find below their user details:
																<ul>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Your status for Order '.$order_id.' has been updated to <b>'.$status.'</b>! 
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the updated Order details please click the “Order” button below (or <a href="'.base_url().'my_order" target="_blank">'.base_url().'my_order</a>).
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'my_order" style="text-decoration:none; color:#FFF;" data-color="link-white">Order</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the updated Order status please click the “Sales” button below (or <a href="'.base_url().'sales" target="_blank">'.base_url().'sales</a>).
																				</multiline>
																			</td>
																		</tr>
																		...
																		<tr>
																			<td style="line-height:30px; font-size:30px;" valign="middle" align="center" height="30">
																				As a thank you, we would like to offer you 1 month free to our subscription service (track & analyse your Sales, get market news with demand maps coming soon, otherwise we just send you this email), click here to apply this to your account. Or £20 cashback if you refer a friend.
																			</td>
																		</tr>
																		<tr>
																			<td style="line-height:30px; font-size:30px;" valign="middle" align="center" height="30">
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'sales" style="text-decoration:none; color:#FFF;" data-color="link-white">Sales</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the updated Order status please click the “Order Status” button below (or <a href="'.base_url().'view_all_orders" target="_blank">'.base_url().'view_all_orders</a>).
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'view_all_orders" style="text-decoration:none; color:#FFF;" data-color="link-white">Order Status</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					Your payment status for Order '.$real_order.' has been updated to <b>'.$selectedstat.'</b>.
																				</multiline>
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the updated Order details please click the “Sales” button below (or <a href="'.base_url().'sales" target="_blank">'.base_url().'sales</a>).
																				</multiline>
																			</td>
																		</tr>
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					To view the updated Order details please click the “Order” button below (or <a href="'.base_url().'view_all_orders" target="_blank">'.base_url().'view_all_orders</a>).
																				</multiline>
																			</td>
																		</tr>
																						...
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="160" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;" data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline>
																											<a href="'.base_url().'view_all_orders" style="text-decoration:none; color:#FFF;" data-color="link-white">Order</a>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
...
<a href="https://www.facebook.com/protectbox/" ><img src="'.base_url().'images/fb-1.png" width="30px"> </a>
	...
	public function techdata_uk_orders($smb_email,$smb_name,$insert_order,$currency,$bundle_price,$sme_id,$supplier_name,$service_name,$manuf,$smb_company)
	{
		$message = '<!doctype html>
							<html lang="en">
							 <head>
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					We have received a payment of '.$currency.' '.number_format($bundle_price,2).' for the below Sale, invoice attached: 
																					<ul>
																						<li>TD UK account number : 742397</li>
																						<li>TD UK account name : ProtectBox Ltd</li>
																						<li>TD UK account address : Blick Studios, 46 Hill Street, Belfast, BT1 2LB, UK</li>
																						<li>TD UK account contacts : kiran@protectbox.com</li>
																						<li>Product Stock Code ordered: '.$manuf.'</li>
																						<li>Product ordered: '.$supplier_name.' '.$service_name.'</li>
																						<li>Order Quantity: 1 </li>
																						<li>Order Price: '.number_format($bundle_price,2).' </li>
																						<li>Currency: '.$currency.'</li>
																						<li>End-user SMB email to whom order is to be sent: '.$smb_email.' </li>
																						<li>ProtectBox Order number: '.$insert_order.' </li>
																						<li>Small & Medium Business (SMB) Customer Name: '.$smb_name.' </li>
																						<li>Small & Medium Business (SMB) Company Name: '.$smb_company.' </li>																						
																					</ul>
																				</multiline>
																			</td>
