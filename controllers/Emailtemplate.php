																				...
																				<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																					<tr>
																						<td valign="top" align="left">
																							<table class="two-left-inner" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
																								<tr>
																									<td  data-bgcolor="theme-bg" valign="middle" align="center" height="48">
																										<multiline style="background: rgb(108, 167, 27); font-family: Open Sans, Verdana, Arial; font-size: 14px; color: rgb(255, 255, 255); font-weight: normal; text-transform: uppercase; line-height: 28px; border-radius: 25px;padding: 10px 10px;">
																											<a href="https://www.staging.protectbox.com/my_order" style="text-decoration:none; color:#FFF;" data-color="link-white">Order Status</a>
																										</multiline>
																									</td>
																								</tr>
																								...
																								<tr>
																									<td style="line-height:20px; border-bottom: 1px solid #000; font-size:20px;" valign="middle" align="center" height="20">
																...
																<td style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;" valign="middle" bgcolor="#FFFFFF" align="center">
																	<table class="two-left-inner" width="490" cellspacing="0" cellpadding="0" border="0">
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					We have received a payment of '.$currency.' '.$bundle_price.' for the below Sale, invoice attached:  
																		...
																		<tr>
																			<td style="font-family:Open Sans, Verdana, Arial; font-size:16px; color:#767676; font-weight:normal; line-height:32px;" valign="top" align="left">
																				<multiline>
																					This payment has been processed to your account. Please allow a few working days for the transfer to complete. To check the sale status, please click the "Sales Status" button below (or <a href="https://www.staging.protectbox.com/my_order" target="_blank">https://www.staging.protectbox.com/my_order</a>), Still need help? Email supplier@protectbox.com or call +44 (0)207 993 3037) or use chat on our website.
																				</multiline>
																			</td>
																		</tr>
