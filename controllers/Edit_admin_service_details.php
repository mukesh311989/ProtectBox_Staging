...
class Edit_admin_service_details extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('edit_admin_service_details',$data);
...
/* End of file Edit_admin_service_details.php */
/* Location: ./application/controllers/Edit_admin_service_details.php */