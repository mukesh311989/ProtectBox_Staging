							...
							<div class="form-group">
								...
								<span>Sage Financials shows:</span>&nbsp;&nbsp;
									...
									<div class="table-responsive" style="margin-top:15px;">
										<table id="" class="table table-striped table-bordered  example">
											...
											?>
											 <tr>
												...
												<td ><?php echo $this->session->userdata['salesforce']['currency'];?><?php echo $key['price'];?></td>
											  </tr>
											<?php
											}
											?>
										...
										<?php 
											$unique_account_data =  $this->session->userdata['sage']['operating_system_use'];
												...
												<table id="" class="table table-striped table-bordered  example">
													...
													<tbody>
													  ...
													  <tr>
														<td><?php echo $i;?></td>
														<td><?php echo $key['product'];?></td>
														<td><?php echo $this->session->userdata['sage']['currency'];?>&nbsp;<?php echo $key['price'];?></td>
													  </tr>
													  <?php
														  $i++;
														}
					  ...
					  <div class="step">
						<div class="row">
						  ...
						  <div class="col-md-6 col-sm-6">
							...
							<span>Sage Accounting shows:</span>&nbsp;&nbsp;
							<?php 
								$unique_sage_data =  $this->session->userdata['sage']['antivirus_installed'];
							?>
									<div class="table-responsive" style="margin-top:15px;">
										<table id="" class="table table-striped table-bordered  example">
						...
						<div class="row">
						  ...
						  <?php
								if(isset($this->session->userdata['salesforce']['basic_system_firewall']) && sizeof($this->session->userdata['salesforce']['basic_system_firewall']) > 0)
										{
								?>
								<span>Sage shows:</span>&nbsp;&nbsp;
									<?php 
										$unique_sage_data = array_unique($this->session->userdata['salesforce']['basic_system_firewall']);
									?>
									<div class="table-responsive" style="margin-top:15px;">
										<table id="" class="table table-striped table-bordered  example">
										...
										<span>Sage Accounting shows:</span>&nbsp;&nbsp;
										<?php 
											$unique_sage_data = $this->session->userdata['sage']['basic_system_firewall'];
										?>
												<div class="table-responsive" style="margin-top:15px;">
												<table id="" class="table table-striped table-bordered  example">
							...
							<div style="padding:10px;">
							  <?php
								if(isset($this->session->userdata['salesforce']['encrypt_data']) && sizeof($this->session->userdata['salesforce']['encrypt_data']) > 0)
										{
								?>
								<span style="margin-top:20px;margin-bottom:20px;">Sage shows:</span>&nbsp;&nbsp;
									<?php 
										$unique_sage_data = array_unique($this->session->userdata['salesforce']['encrypt_data']);
									?>
								<div class="table-responsive" style="margin-top:15px;">
									<table id="" class="table table-striped table-bordered  example">
										...
										<?php 
											$unique_sage_data =  $this->session->userdata['sage']['encrypt_data'];
										?>
						...
						<div class="row">
							 ...
							 <div class="row">
							  ...
							  <img src="<?php echo base_url();?>images/deligate_icon.png" class="authentication_button" style="height:15px;cursor: pointer;margin-top: -2px;">
								...
								<span>Sage shows:</span>&nbsp;&nbsp;
									<?php 
										$unique_sage_data = array_unique($this->session->userdata['salesforce']['two_factor_authentication']);
									?>
										<div class="table-responsive" style="margin-top:15px;">
											<table id="" class="table table-striped table-bordered  example">
												...
												<tbody>
														...
														?>
														 <tr>
															<td style=" border:1px solid black;"><?php echo $key['order_date'];?></td>
															<td style=" border:1px solid black;"><?php echo $key['product'];?></td>
															<td style=" border:1px solid black;"><?php echo $key['price'];?></td>
														  </tr>
														<?php
														}
														?>
										...
										<span>Sage Accounting shows:</span>&nbsp;&nbsp;
										<?php 
											$unique_sage_data =  $this->session->userdata['sage']['two_factor_authentication'];
										?>
						...
						<div class="row">
						  ...
						  <div class="col-md-6 col-sm-6">
							  ...
							  <?php
								...
								<span style="margin-top:20px;margin-bottom:20px;">Sage shows:</span>&nbsp;&nbsp;
									<?php 
										$unique_sage_data = array_unique($this->session->userdata['salesforce']['security_monitoring_solution']);
									?>
								<div class="table-responsive" style="margin-top:15px;">
									<table id="" class="table table-striped table-bordered  example">
										...
										?>
											<span style="margin-top:20px;margin-bottom:20px;">Sage Accounting shows:</span>&nbsp;&nbsp;
											<?php 
												$unique_sage_data = $this->session->userdata['sage']['security_monitoring_solution'];	
											?>
											<div class="table-responsive" style="margin-top:15px;">
												<table id="" class="table table-striped table-bordered  example">
						...
						<div class="row">
						  ...
						  <div class="col-md-6 col-sm-6">
							  ...
							  <div style="padding:10px;">
								...
								<span>Sage shows:</span>&nbsp;&nbsp;
									<?php 
										$unique_sage_data = array_unique($this->session->userdata['salesforce']['have_msp']);
									?>
								<div class="table-responsive" style="margin-top:15px;">
									<table id="" class="table table-striped table-bordered  example">
