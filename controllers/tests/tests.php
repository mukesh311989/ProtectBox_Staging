...
// already got some credentials stored?
    ...
    if (isset($_GET['payments'])) {
       if (!isset($_GET['method'])) {
        ...
        } elseif (isset($_GET['method']) && $_GET['method'] == "post" && $_GET['payments']== 1 ) {
              $response = $XeroOAuth->request('GET', $XeroOAuth->url('Payments', 'core'), array('Where' => 'Status=="AUTHORISED"'));
               if ($XeroOAuth->response['code'] == 200) {
    ...
    if (isset($_REQUEST['invoice'])) {
        ...
        } elseif (isset($_GET['method']) && $_GET['method'] == "put" && $_REQUEST['invoice']== 1 ) {
            $xml = "<Invoices>
                      <Invoice>
                        <Type>ACCREC</Type>
                        <Contact>
        ...
        } elseif (isset($_GET['method']) && $_GET['method'] == "4dp" && $_REQUEST['invoice']== 1 ) {
            $xml = "<Invoices>
                      <Invoice>
                        <Type>ACCREC</Type>
                        <Contact>
        ...
        } elseif (isset($_GET['method']) && $_GET['method'] == "post" ) {
            $xml = "<Invoices>
                      <Invoice>
                        <Type>ACCREC</Type>
                        <Contact>
        ...
        }elseif (isset($_GET['method']) && $_GET['method'] == "put" && $_REQUEST['invoice']=="attachment" ) {
...
if (isset($_GET['invoicesmodified'])) {
   ...
   if (isset($_GET['banktransactions'])) {
       if (!isset($_GET['method'])) {
		   echo "test2";
...
if( isset($_REQUEST['items'])) {
   ...
   if (isset($_REQUEST['trackingcategories'])) {
     if (!isset($_GET['method'])) {
     ...
     }elseif (isset($_GET['method']) && $_GET['method'] == "getarchived") {
     ...
     }elseif (isset($_GET['method']) && $_GET['method'] == "put" && $_REQUEST['trackingcategories']== 1 ) {
        ...
        }elseif (isset($_GET['method']) && $_GET['method'] == "archive" && $_REQUEST['trackingcategories']== 1 ) {
        ...
        }elseif (isset($_GET['method']) && $_GET['method'] == "restore" && $_REQUEST['trackingcategories']== 1 ) {
            $xml = "<TrackingCategories>
                      <TrackingCategory>
                        <Name>Region</Name>
   ...
   if (isset($_REQUEST['folders'])) {
    ...
    }elseif (isset($_GET['method']) && $_GET['method'] == "files" && $_REQUEST['folders']== 1 ) {
