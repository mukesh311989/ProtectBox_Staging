...
<html lang="en">
  <head>
    ...
    <title>Stripe Payment Failed | ProtectBox</title>
    <!-- Favicons-->
      ...
      <div class="container margin_60">
        ...
        <div class="row">
			...
			<div class="col-md-12 rounded_div" style="padding:15px;">	
				<div style="" class="thank_you">Oops...!!!</div>
				<div style="" class="order_success">There was a problem processing your request</div>
				...
				<div class="col-md-12" style="margin-top:70px;">
					...
					<div class="col-md-10 col-sm-10">
						<div style="" class="email_recipt"><i>An email receipt including the details about your Subscription has been <br/> sent to the email address <b><?php echo $this->session->userdata['logged_in']['email'];?></b>. Please keep it for your records</i></div>
					</div>
				</div>
				...
				<div class="col-md-12" style="margin-top:30px;">
					...
					<div class="col-md-10" style="text-align:right;">
						<div style="" class="visit"><i>Please visit <a href="<?php echo base_url('sales');?>" style="color:#000;text-decoration:underline;">Dashboard</a> now to retry payment for subscription.</i></div>
					</div>
					<?php
						}else if($this->session->userdata['logged_in']['user_type'] == 'Small and medium business'){	
					?>
					<div class="col-md-10" style="text-align:right;">
						<div style="" class="visit"><i>Please visit <a href="<?php echo base_url('questionniare_results');?>" style="color:#000;text-decoration:underline;">Subscription</a> now to retry payment for subscription.</i></div>
					</div>
					<?php
						}	
					?>
