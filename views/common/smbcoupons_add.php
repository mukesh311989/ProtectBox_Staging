						...
						<div class="row">
						  <div class="col-md-6 col-sm-6">
							<div class="form-group">
							  ...
							  <input type="text" class="form-control coupn_code" name="coupon_code" value="" required>
							</div>
						  </div>
						  <div class="col-md-6 col-sm-6">
							<div class="form-group">
						...
						<div class="row">
						  <div class="col-md-6 col-sm-6">
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="discount_value" value="" required>
							</div>
						  </div>
						  <div class="col-md-6 col-sm-6">
