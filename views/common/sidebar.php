...
<div class="col-md-3">
 ...
 <?php
  }else if(isset($this->session->userdata['logged_in']['user_type']) && $this->session->userdata['logged_in']['user_type'] == "delicate"){
 ?>
 <div class="col-md-3">
  <div class="box_style_1 hidden-xs rounded_div affix" data-spy="affix" data-offset-top="200" data-offset-bottom="355" style="padding: 20px;position: fixed;width: 280px;">
	<div class="widget">
		...
		<ul id="cat_nav">
			<li><a href="<?php echo base_url('delicate_questionaire');?>" style="color:#73859B;"> Informations</a></li>
		</ul>
	</div><!-- End widget -->
   </div>               
 </div>
