        ...
        <div class="row">
			...
			<div class="col-md-12 rounded_div" style="padding:15px;">	
				...
				<div class="col-md-12" style="margin-top:30px;">
					...
					<div class="col-md-10 col-sm-10" style="margin-top:10px;">
						<div style="" class="visit"><i>Please visit <a href="<?php echo base_url("my_order");?>" style="color:#000;text-decoration:underline;">Orders page</a> now to download (and again at any time to re-download) the necessary details with regards to the activation of your order Number<b>&nbsp;<?php echo $this->uri->segment(2)?></b>. </i></div>
					</div>
				</div>
				<div class="col-md-12" style="margin-top:30px;">
					<div class="col-md-2 col-sm-2" style="text-align:right;">
						<img src="<?php echo base_url()?>images/favicon.png" style="height:50px;">
					</div>
					<div class="col-md-10 col-sm-10" style="margin-top:10px;">
						<div style="" class="subscription"><i>Please visit <a href="<?php echo base_url("my_order");?>" style="color:#000;text-decoration:underline;">Subscription </a> to monitor the progress of your subscription in your order number<b>&nbsp;<?php echo $this->uri->segment(2)?></b>. </i></div>
