...
<html lang="en">
  <head>
    ...
    <title>Delegate Login | ProtectBox</title>
    <!-- Favicons-->
      ...
      <div class="container margin_60">
        <div class="row">
          <div class="col-md-6 col-md-offset-3" style="padding: 10px 25px 10px;border: 1px solid #CCC;box-shadow: 0px 0px 3px #bfbfbf;border-radius: 5px;background:#f5f5f5">
            ...
            ?>
            <form name="login_page" action="<?php echo base_url('delegate_login/check_login');?>" method="POST">
              ...
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
                  <button type="submit" class="btn btn-success btn-lg col-md-offset-5">Login
                  </button>
                </div>
              </div>
			  <div class="row">
