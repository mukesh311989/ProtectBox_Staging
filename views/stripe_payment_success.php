...
<html lang="en">
  <head>
    ...
    <title>Stripe Payment Successful | ProtectBox</title>
    <!-- Favicons-->
  ...
  <body>
    ...
    <main>    
      ...
      <div class="col-md-12 rounded_div" style="padding:15px;"> 
        ...
        <div style="" class="order_success">Your Subscription Was Completed Successfully</div>
		...
		<div class="col-md-12" style="margin-top:30px;">
			...
			?>
            <div style="" class="subscription"><i>Please visit <a href="<?php echo base_url("sales");?>" style="color:#000;text-decoration:underline;">Dashboard </a> to monitor your sales information. </i></div>
			<?php
				}else if($this->session->userdata['logged_in']['user_type'] == 'Small and medium business'){	
			?>
			<div style="" class="subscription"><i>Please visit <a href="<?php echo base_url("questionniare_results");?>" style="color:#000;text-decoration:underline;">Subscription </a> to monitor your answers and our tool. </i></div>
			<?php
				}	
			?>
        </div>
