...
<html lang="en">
  <head>
    ...
    <title>Payment Process Service | ProtectBox</title>
    <!-- Favicons-->
				...
				<div class="row">
				  <div class="col-md-12 col-sm-5">
					<div class="form-group">
						<form name="copnsss" action="<?php echo base_url();?>payment_process_service/addcoupn" method="POST">
							<div class="col-md-6">
								<?php
           ...
           <div class="col-md-12 rounded_div space"  id="hide_pay_data">
              ...
              <div class="col-md-8">
                ...
                <div class="col-md-6 what">
					 <div class="c_names">
							<?php echo $service_data->product_category;?>
					 </div>
				<?php
					  	$logos = $service_data;
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="col-md-12 details_sub" >
							   <div class="checkbox">
								  <label>
								  		<form method="post" action="<?php echo base_url('payment_process_service/sme_subscribe');?>">
					...
					<div class="row">
					  ...
					  <div class="col-md-3 col-sm-3">
						...
						<?php
							...
							$get_user_info = $this->payment_process_service_m->user_info($user_id);
						?>
						<form id="credit_1" >
					...
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
						  <div class="input-group" id="card-number-field">
							...
							<input autocomplete='off' class='form-control card-number' size='20' placeholder="Card Number" type='text' id="cardNumber">
						  </div>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
						  <div class="input-group">
							...
							<input autocomplete='off' class='form-control card-cvc' placeholder='ex. 311' size='4' type='text' id="cvv">
  	...
  	<script>
		...
		var credit_data = {
			'form_id':'credit_1',
			 ...
			 'post_code':'EC2A4NE',
			 'callback_url':'https://www.staging.protectbox.com/payment_process_service/credit_response',
