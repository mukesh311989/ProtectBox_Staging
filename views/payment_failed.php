...
<html lang="en">
  <head>
    ...
    <title>Payment Failure | ProtectBox</title>
    <!-- Favicons-->
			...
			<div class="col-md-12 rounded_div" style="padding:15px;">	
				...
				<div class="col-md-12" style="margin-top:70px;">
					...
					<div class="col-md-10 col-sm-10">
						<div style="" class="email_recipt"><i>An email receipt including the details about your order <b>#<?php echo $this->uri->segment(2)?></b> has been <br/> sent to the email address <b><?php echo $this->session->userdata['logged_in']['email'];?></b>. Please keep it for your records</i></div>
					</div>
				</div>
