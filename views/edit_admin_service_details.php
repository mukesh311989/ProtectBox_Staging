...
<html lang="en">
  <head>
    ...
    <title>Edit Services | ProtectBox</title>
    <!-- Favicons-->
      ...
      <div class="container margin_60">
        ...
        <div class="row">
			...
			<div class="tab-content rounded_div">
					...
					<form name="supplier_information" action="<?php echo base_url();?>edit_admin_service_details/add_service" enctype="multipart/form-data" method="POST">
					  ...
					  <div class="form_title">
					  	...
					  	<div class="col-md-12">
							<div class="col-md-6">
								<h3>
								  <strong><i class="icon-th-list"></i></strong>Edit Services
								</h3>
							</div>
							<div class="col-md-6 text-right">
								<a href="<?php echo base_url('view_all_services');?>" class="btn btn-warning">Back</a>
							</div>
						</div>
					  </div>
					  <div class="step">
