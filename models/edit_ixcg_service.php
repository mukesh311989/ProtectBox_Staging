						  ...
						  <div class="row">
							  ...
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
									<label>Supplier Name</label>
								  	<input type="text" class="form-control" name="new_supplier_name" value="<?php echo $get_service_details->manufacture;?>">
							  ...
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
								    ...
								    <input type="text" class="form-control" name="new_service_name" value="<?php echo $get_service_details->product_description;?>">
								</div>
							  </div>
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
							...
							<div class="row">
							  <div class="col-md-3 col-sm-3">
									<div class="form-group ">
									  <label>Product Category</label>
										  <select class="form-control required" name="solution_category"  multiple style="height:110px;">
											<option disabled="disabled">Please select all applicable (+shift/cmd - select multiple options)</option>
											<?php 
												$explode_supplier_category = explode(',',$get_service_details->product_type);
								...
								<div class="form-group">
								  <label>Product Detail</label>
									...
									<select class="form-control required felbovalue" name="product_detailzz" id="product_detailzz">
										...
										<?php
											if(isset($values->product_category) && $values->product_category == "Data Storage"){
										?>
										...
										<?php
											...
											else if(isset($values->product_category) && $values->product_category == "Cyber Insurance"){
										?>
							 ...
							 <div class="col-md-3 col-sm-3">
								<div class="form-group">
									...
									<select class="form-control required" name="price_currency" >
							  ...
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
									...
									<select class="form-control" name="price_range">
										...
										<option value="5000-10000">5'000 - 1'0000</option>
							...
							<div class="row">
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
								   ...
								   <input type="text" class="form-control" name="price_details" value="<?php echo $get_service_details->gross_price?>">
								</div>
							  </div>
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
							  ...
							  <div class="col-md-3 col-sm-3">
								<div class="form-group">
									...
									<select class="form-control" name="regulation">
										...
										<option value="PDPA (Singapore)" <?php echo((isset($values->location) && $values->location == "PDPA (Singapore)") ? 'selected' :'')?>>PDPA (Singapore)</option>
								  </select>
								</div>
							  </div>
